...
export async function getMessages(req, reply)
{
    ...
    // lastMessages.push({sender_id: 0, username: "System", avatar_url: "/public/default_pfp.png", msg: "Please be respectful and tolerant of other users.", created_at: new Date().toISOString()});
